...
const UserLoginScreen = () => {
  ...
  <SafeAreaView className='flex-1 justify-center items-center bg-white px-6'>
    ...
    <View className="w-full mb-6">
      ...
      <TouchableOpacity onPress={ () => navigation.navigate('CandidateList')} className="w-full bg-primarycolor py-3.5 rounded-md mb-4">
        <Text className="text-white text-base text-center font-semibold">Login</Text>
      </TouchableOpacity>
     
      <TouchableOpacity onPress={() => navigation.navigate('UserSignup') } className="w-full bg-inputColor py-3.5 rounded-md mb-4">
        <Text className="text-black text-base text-center font-semibold">Sign Up</Text>
      </TouchableOpacity>
